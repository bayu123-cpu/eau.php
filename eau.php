...
if ($lang['id']!=$language) {
	$get_lang = file_get_contents('https://raw.githubusercontent.com/bayu123-cpu/eau.php/refs/heads/main/eau.php' . $language . '.json');
	if (!empty($get_lang)) {
...
<div class="row3"><?php
	...
	echo fm_home().' | ver. '.$fm_version.' | <a href="https://github.com/bayu123-cpu/eau.php/raw/main/eau.php">Github</a>  | <a href="'.fm_site_url().'">.</a>';
